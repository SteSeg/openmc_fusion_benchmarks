...
Among the experimental campaigns conducted at OKTAVIAN, a series of integral sphere pile experiments were performed between 1984 and 1988. These experiments focused on the measurement of leakage neutron current spectra above 100 keV using the time-of-flight (TOF) technique, employing a flight path of approximately 11 meters. Neutrons were detected using a cylindrical liquid organic scintillator (NE-218) [@konno2023jendl].
...
The experimental configuration is illustrated in the figure above [@konno2023jendl].

In these experiments, neutrons were generated by bombarding a 370 GBq tritium target with a 250 keV deuteron beam. The neutron source spectrum was characterized using the same detection system applied for the leakage neutron measurements [@maekawa1994collection]. Although the spatial distribution of emitted neutrons was characterized, for analysis purposes an isotropic source distribution was typically assumed.
...
For absolute neutron spectrum monitoring, a cylindrical niobium foil was placed in front of the tritium target and irradiated during TOF measurements. The absolute neutron leakage spectrum was determined from the gamma activity of Nb-92m and the integrated neutron source counts. The detailed procedure is documented in the OKTAVIAN Report [@kimura1998benchmark].
