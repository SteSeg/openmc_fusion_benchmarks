...
<p align="center">
  <img src="images/al_neutron_leakage_csg_cad.svg" width="400" alt="Neutron leakage CAD vs CSG">
  <br>
  <em>Figure 2: Neutron leakage spectrum comparison between CAD and CSG geometries.</em>
</p>

<p align="center">
  <img src="images/al_photon_leakage_csg_cad.svg" width="400" alt="Photon leakage CAD vs CSG">
  <br>
...
<p align="center">
  <img src="images/al_neutron_leakage_nuclear_data.svg" width="400" alt="Neutron leakage nuclear data in CAD">
  <br>
  <em>Figure 4: Neutron leakage spectrum for different nuclear data libraries using CAD geometry.</em>
</p>

<p align="center">
  <img src="images/al_photon_leakage_nuclear_data.svg" width="400" alt="Photon leakage nuclear data in CAD">
  <br>
...
<p align="center">
  <img src="images/al_neutron_leakage_uq.svg" width="800" alt="Neutron leakage UQ">
  <br>
  <em>Figure 6: Neutron leakage spectrum with TMC-UQ results.</em>
</p>

<p align="center">
  <img src="images/al_photon_leakage_uq.svg" width="800" alt="Photon leakage spectrum UQ">
  <br>
